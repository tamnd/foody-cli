...
Most of these come down to network reality or how foody serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

foody rate-limits like any public site. foody already paces
...
Where a surface is gated, foody reads a cookie or token you supply
...
`foody`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what foody actually did
